    ...
    <div className="container mt-5">
      <div className="row row-cols-1 row-cols-md-4 g-4">
        <div className="col">
          <div className="card">
            <img
              src="https://medschool.umich.edu/sites/default/files/styles/rounded_1_1/public/2023-06/johnforen.jpg?h=6133d959&itok=g4dd2UVF"
              className="card-img-top"
              alt="Steven Pinker"
            />
            <div className="card-body">
              <h5 className="card-title">Steven Pinker</h5>
              <p className="card-text">Chancellor</p>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card">
            <img
              src="https://www.nottingham.ac.uk/News/images/ColinCampbell1.jpg"
              className="card-img-top"
              alt="ALBERT"
            />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card">
            <img
              src="https://c8.alamy.com/comp/W0FN3B/james-schlessinger-professor-at-stanford-university-testifies-before-the-senate-foreign-relations-committee-regarding-us-russian-arms-control-issues-on-capitol-hill-in-washington-on-april-29-2010-upiroger-l-wollenberg-W0FN3B.jpg"
              className="card-img-top"
              alt="EDWARD"
            />
            <div className="card-body">
              <h5 className="card-title">EDWARD</h5>
              <p className="card-text">Payroll Manager</p>
